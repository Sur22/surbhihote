...
export function CaseStudySideNav({
  ...
  return (
    <nav
      ...
      className={`hidden min-[1200px]:block fixed top-24 left-4 min-[1620px]:left-[calc(50%-810px+24px)] right-auto w-[180px] min-[1620px]:w-[220px] z-40 transition-opacity duration-200 ${
