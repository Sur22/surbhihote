...
const services = [
  ...
  { n: "02", t: "Absolute Learner", d: "Learning is something I love. It may be the design, new technology, business , a new perspective or something which makes me curious." },
