      ...
      <section id={topOutcomeSlugs.has(c.slug) ? "reflection" : "impact"} className="mx-auto max-w-[1080px] px-6 md:px-10 pt-24 pb-0 scroll-mt-24">
        ...
        <p className="text-lg leading-relaxed text-foreground/85 mb-20">
          {c.slug === "fjord2" 
            ...
            : (c.slug === "atlas" || c.slug === "atlas2")
            ? "The redesign did what it set out to do: users could finally control notifications at the level that matched their work company, product, and lifecycle stage and the critical alerts stopped drowning in the noise. That fed directly into fewer missed deadlines and a better client experience, which mattered for retention. But the harder lesson was that giving users control is not the same as reducing their burden. Preferences at that many levels can quietly become their own kind of overwhelm so 'Notification Template' (ability designed in web version of notifications) was created for every user group based on their job description and what is important to them based on the research I carried out which was confirmed by all the user groups and implemented."
