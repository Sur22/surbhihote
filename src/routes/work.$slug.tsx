...
Every product could have customized stages. Overall there were 35+ types of notifications on the platform.\u00a0`}
      ...
      <section id="impact" className="mx-auto max-w-[1080px] px-6 md:px-10 pt-24 pb-0 scroll-mt-24">
        ...
        <p className="text-lg leading-relaxed text-foreground/85 mb-20">
          {c.slug === "fjord2" 
            ? <>This project is a major project. As a legacy application users are not easily ready to change and adopt to the new interface but I tried to keep the learning curve as flat as possibly I could and we tried to address their major pain points in the workflows like speed, stability, broken functionalities fixed, redundancy, manual refresh etc. The highlight is avoiding any loss of business which is till date is $0 since it is launched.</>
            : c.slug === "fjord"
