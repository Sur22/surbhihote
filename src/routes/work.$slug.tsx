...
function CaseStudyPage() {
  ...
  return (
    <SiteLayout>
      ...
      {/* Outcomes */}
      <section className="mx-auto max-w-[768px] px-6 md:px-10 pt-0 pb-6">
      ...
      {/* Final Thoughts */}
      <section id="impact" className="mx-auto max-w-[768px] px-6 md:px-10 pb-10 scroll-mt-24">
      ...
      <section className="border-t border-border">
        <div className="mx-auto max-w-[768px] px-6 md:px-10 pt-20 pb-10">
