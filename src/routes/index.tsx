          ...
          <div className={`md:col-span-6 ${i % 2 === 1 ? "md:order-2" : ""}`}>
            <div className="overflow-hidden rounded-[5%]">
              <img
                ...
                height={1000}
                loading="lazy"
                className={`w-full h-[420px] transition-transform duration-[1200ms] group-hover:scale-[1.02] rounded-[5%] shadow-md ${c.slug === "fjord" || c.slug === "fjord2" || c.slug === "solace" || (c.slug === "atlas" || c.slug === "atlas2") ? "object-contain" : "object-cover"}`}
              />
            </div>
          </div>
