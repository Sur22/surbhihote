          ...
          <div className={`md:col-span-6 ${i % 2 === 1 ? "md:order-2" : ""}`}>
            <div className="overflow-hidden rounded-[5%]">
              <img
                ...
                height={1000}
                loading="lazy"
                className={`w-full h-[420px] transition-transform duration-[1200ms] group-hover:scale-[1.02] rounded-[5%] shadow-md ${c.slug === "fjord" || c.slug === "fjord2" || c.slug === "solace" || c.slug === "atlas" ? "object-contain" : "object-cover"}`}
              />
            </div>
          </div>
    ...
    <SiteLayout>
        ...
        <div className="grid md:grid-cols-12 gap-10 items-start">
          ...
          <div className="md:col-span-7 md:order-2 font-serif md:text-5xl text-6xl">
            ...
            <p className="mt-8 text-lg leading-relaxed text-foreground/80 font-sans">
              Identifying the equilibrium between user needs, business opportunities, and technological possibilities to make an impact/ convert complex problems to simplified solutions.
            </p>
            <div className="mt-8">
      ...
      <section id="case-studies" className="mx-auto max-w-[1100px] px-6 md:px-10 py-20 scroll-mt-20">
        <div className="mb-12">
          ...
          <h2 className="font-serif text-4xl md:text-4xl">Case studies</h2>
        </div>
