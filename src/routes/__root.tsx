...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Leading the design and delivery of scalable, user-centered B2B and SaaS enterprise products across web and mobile." },
      { name: "author", content: "Surbhi Hote" },
      { property: "og:title", content: "Surbhi Hote — Lead Product Designer" },
      { property: "og:description", content: "Leading the design and delivery of scalable, user-centered B2B and SaaS enterprise products across web and mobile." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Surbhi Hote — Lead Product Designer" },
      { name: "twitter:description", content: "Leading the design and delivery of scalable, user-centered B2B and SaaS enterprise products across web and mobile." },
