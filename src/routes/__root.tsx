...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:description", content: "Design leader with 8+ years designing and scaling complex B2B, SaaS, & enterprise products across web & mobile. Expert in end-to-end & human-centered design." },
