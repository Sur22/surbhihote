...
const _caseStudies: CaseStudy[] = [
  {
    ...
    goal: "All the affiliates working with the company has been using the 20 years old site which has many things which is not working.\n1. Some parts of the website are not used anymore\n2. Slow and clunky\n3.\u00a0cannot add new functionality because of old codebase\n4. To get updated data user has to keep on refreshing manually after every few minutes so they don’t miss any of the orders or the order revisions.\n5. Some functionalities are broken and need to be fixed\u00a0\n6. Dated UI/UX.\n",
    research: {
    ...
    outcome: [
      ...
      { label: "Faster Paltform", value: "+22%" },
    ],
    sections: [
      {
        heading: "Discovery",
