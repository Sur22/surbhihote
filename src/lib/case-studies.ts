...
const _caseStudies: CaseStudy[] = [
  {
    ...
    timeframe: "3 Months",
    tools: "Survey Monkey,\u00a0Claude,\nChat GPT Microsoft Clarity, Power BI, Microsoft Azure, Teams, Adobe XD",
