...
const defaultMeta = {
  ...
  goal:
    "The goal is to give users flexibility and control on subscribing to the notifications which are useful and important for their job.\n1. Provide different user types ability to pick and choose the notifications which are important for their role or job responsibilities.\n2. Serve users ability to choose the notifications that they would like to receive per module /product stage/ product / company.\n3. Allow users ability to switch on/off notifications at any point of time.\n\n\n",
  research: {
