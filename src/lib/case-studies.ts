...
const defaultMeta = {
  ...
  tasksPerformed:
    "0 to 1 Design, Lean UX,User Research, UI Design, Component Design, User Flows, Wire-framing, Prototyping, Usability Testing, Design Handoff, Collaboration with Product, Engineering, and QA teams.",
  overview:
